...
<script type="text/javascript">
	function formatar(mascara, documento){
	  ...
	  if (texto.substring(0,1) != saida){
         ...
         <script type="text/javascript">
            function validaForm(){
                var campoPreco = document.form_produto.preco.value;
                var campoNome = document.form_produto.nome.value;
                var campoUnidadeMedida = document.form_produto.unidadeMedida.value;
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Formulário para inserir produtos
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="InserirProduto.do" onsubmit="return validaForm();">
