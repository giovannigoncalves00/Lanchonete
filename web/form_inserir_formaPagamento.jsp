    ...
    <script type="text/javascript">
            function formatar(mascara, documento){
             ...
             <script type="text/javascript">
                function validaForm(){
                    var campoid_formaPagamento = document.form_formaPagamento.id_formaPagamento.value;
                    var campoTipo = document.form_formaPagamento.tipo.value;


                     if(campoid_formaPagamento==""){
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Inserir Forma de Pagamento</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Formulário para cadastrar Formas de pagamentos
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" method="post" action="InserirFormaPagamento.do" >
